//! Annotation and anchor types shared by plannotator-tui and Plannotator Workspaces.
//!
...
//! server; the web client reads `originalText`, and everything plannotator-tui needs to re-find a
//! selection rides under one `plannotator_tui` key. See `docs/decisions.md` for the reasoning.
//!
...
pub use annotation::{
    Annotation, AnnotationExtras, ApiError, CreateAnnotation, LocalAttachment, PatchAnnotation, Reply, State,
};
